...
public class BeanBrowser {
	...
	/**
	 * Constructeur instancie user et filtre
	 */
	public BeanBrowser() {
	...
	/**
	 * creating SQL request from checked filter
	...
	public String getRequeteFiltre() {
		...
		for (BlocFiltre indiceBlocFiltre : this.listBlocFiltre) {
			...
			if (s != null) {
				...
				if (indiceBlocFiltre.getIdBlocFiltre() == 0 || indiceBlocFiltre.getIdBlocFiltre() == 1
						|| indiceBlocFiltre.getIdBlocFiltre() == 2) {
					requete += sWhere + sAnd + sRequeteProduit;
					sRequeteProduit = "";
					sWhere = "";
					sAnd = " AND ";
				}
				...
				case 0:
					requete += "ID_FAMILLE " + s;
					break;
				case 1:
					requete += "ID_SSFAMILLE " + s;
					break;
				case 2:
					requete += "ID_FABRICANT " + s;
					break;
				case 3:
					if (sRequeteProduit.equals("")) {
						requete += ") AND ";
						sParenthese = "";
					}
